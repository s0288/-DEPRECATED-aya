...
class TestActionSendFastingLog(unittest.TestCase):
    ...
    def test_retrieve_fasting_log_with_fasting_history_and_without_consecutive_fasts(self):
        events = [{"event": "slot", "timestamp": datetime.datetime.timestamp(datetime.datetime.now() -  datetime.timedelta(days=3)), "name": "total_hours_fasted", "value": 22.616666666666667}, {"event": "slot", "timestamp": datetime.datetime.timestamp(datetime.datetime.now() -  datetime.timedelta(days=0)), "name": "total_hours_fasted", "value": 13.983333333333334}, {'event': 'slot', 'timestamp': 1600619208.9505951, 'name': 'mins_fasted', 'value': '53 Minuten'}, {'event': 'slot', 'timestamp': 1600619208.9506164, 'name': 'is_fasting', 'value': 1}] # test events
